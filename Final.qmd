...
identify_missing_values <- function(subgroup_data, subgroup_name) {
  ...
  if (length(missing_value_rows) > 0) {
    ...
    print(subgroup_data[missing_value_rows, ])
  }
}
...
ggsave("figure1.png", figure1, width = 6, height = 4, dpi = 300)
```
...
ggsave("figure2.png", figure2, width = 6, height = 4, dpi = 300)
```
...
ggsave("figure3.png", figure3, width = 6, height = 4, dpi = 300)
```
...
ggsave("figure4.png", figure4, width = 6, height = 4, dpi = 300)
```
...
ggsave("figure6.png", figure6, width = 6, height = 4, dpi = 300)
```
